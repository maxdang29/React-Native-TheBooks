...
export default class Swiper extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (!this.props.autoplay && this.autoplayTimer) {
      ...
      this.setState(
        this.initState(this.props, prevProps.index !== this.props.index),
      );
    }
  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || (
      <View
        style={[
          {
            backgroundColor: this.props.activeDotColor || Colors.primary,
          },
    ...
    const Dot = this.props.dot || (
      <View
        style={[
          {
            backgroundColor: this.props.dotColor || Colors.shadow,
          },
          styles.defaultDotStyle,
          this.props.dotStyle,
        ]}
